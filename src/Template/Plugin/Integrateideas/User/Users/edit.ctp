    ...
    <div class="hpanel">
        ...
        <div class="panel-body">
            ...
            <?= $this->Form->hidden('userId',['value' => $user->id]);?>
                ...
                <?php $jobDesignations =  $editEnterEvent['jobDesignations'];
                      if(!empty($editEnterEvent['getData'])){
                      $setDesignations =  $editEnterEvent['getData'];
                      }                   
                ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <select id='user_job_designations.job_designation_id' class="form-control">
                    <?php foreach($jobDesignations as $key => $value){
                        if($setDesignations == $key){
