 ...
 * @property \Cake\ORM\Association\HasMany $UserTags
 * @property \Cake\ORM\Association\HasMany $Webforms
 *
...
class UsersTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->hasOne('UserJobDesignations', [
            'foreignKey' => 'user_id',
    ...
    public function afterSaveCommit($entity){
        //pr($entity); die('in entity');
    }
}